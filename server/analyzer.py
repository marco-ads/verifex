...
- informativa → Noticia neutral que solo reporta hechos (apertura de negocios, eventos, anuncios oficiales)
- opinion → Columna, editorial o contenido con postura clara del autor
- promocional → Publirreportaje, contenido patrocinado o con intención de vender
...
{{
  ...
  "article_type": "opinion|informativa|promocional|clickbait|denuncia",
  "is_scam": false,
